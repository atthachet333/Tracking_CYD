...
export const DOC_ALIASES: Record<DocField, string[]> = {
  ...
  // สถานะเคส (priority สูงสุด) — resolveStatus จะ fallback ไป quotation/followUp ถ้าว่าง
  status: ["สถานะเคส", "สถานะงาน", "สถานะปัจจุบัน", "ขั้นตอนปัจจุบัน", "ผลการดำเนินการ", "สถานะในระบบ", "สถานะ", "สถานะลูกค้า"],
