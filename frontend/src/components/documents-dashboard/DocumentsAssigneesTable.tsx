...
const COLS = ["พนักงาน", "งานทั้งหมด", "กำลังดำเนินการ", "เสร็จสิ้น", "มีปัญหา", "บริษัท", "ภาระงาน", "งานล่าสุด"];

export function DocumentsAssigneesTable({ data }: { data: DocumentsAssigneeStat[] }) {
